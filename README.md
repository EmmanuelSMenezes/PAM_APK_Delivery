...
**Aplicativo mÃ³vel para entregadores e tÃ©cnicos** da plataforma PAM. Interface otimizada para profissionais em campo, com funcionalidades de gerenciamento de rotas, atualizaÃ§Ã£o de status de pedidos, comunicaÃ§Ã£o com clientes, relatÃ³rios de campo, navegaÃ§Ã£o GPS e otimizaÃ§Ã£o de entregas. Desenvolvido com React Native e Expo.

### ðŸŽ¯ Principais Funcionalidades

- ðŸ—ºï¸ **NavegaÃ§Ã£o GPS**: Rotas otimizadas e navegaÃ§Ã£o turn-by-turn
- ðŸ“‹ **Lista de Pedidos**: GestÃ£o eficiente de tarefas diÃ¡rias
- ðŸ”„ **Status em Tempo Real**: AtualizaÃ§Ãµes instantÃ¢neas
- ðŸ“¸ **RelatÃ³rios de Campo**: Fotos e documentaÃ§Ã£o de serviÃ§os
- ðŸ’¬ **Chat com Clientes**: ComunicaÃ§Ã£o direta e eficiente
- â° **Controle de Tempo**: Registro de horas trabalhadas
- ðŸ“Š **Performance**: MÃ©tricas pessoais e metas
- ðŸ”” **NotificaÃ§Ãµes**: Alertas de novos pedidos
- ðŸ“± **Modo Offline**: Funcionalidades bÃ¡sicas sem internet
- ðŸ›¡ï¸ **SeguranÃ§a**: AutenticaÃ§Ã£o biomÃ©trica
...
- **ðŸ“– Wiki**: [DocumentaÃ§Ã£o Completa](https://github.com/EmmanuelSMenezes/PAM_APK_Delivery/wiki)
...
**[â¬† Voltar ao Topo](#-PAM_APK_Delivery)**
